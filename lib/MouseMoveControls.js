...
THREE.MouseMoveControls = function ( object, domElement ) {
      ...
      this.center = new THREE.Vector3(4,0,0);
      ...
      this.update = function () {
        ...
        this.object.position.x = (-this.object.position.x + this.x) * .03 + this.object.position.x;
        this.object.position.y = (-this.object.position.y + this.y) * .03 + this.object.position.y;
