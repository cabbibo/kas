...
DragonFish.prototype.createVertabrae = function( dom , m1 , m2 , m3 , m4 , id ){
  ...
  for( var i = 0; i < 3; i++ ){
    ...
    var child1 = new Fish( vertabrae , .7 , m2 , id );
    child1.position.copy( vertabrae.position );

    for( var j = 0;  j < 2; j++ ){

      var child2 = new Fish( child1 , .6 , m3 , id );
      child2.position.copy( vertabrae.position );

      for( var k = 0; k < 3; k++ ){

        var child3 = new Fish( child2 , .5 , m4 , id );
...
DragonFish.prototype.addVertabrae = function( m1 , m2 , m3 , m4 ){
  ...
  var v = this.createVertabrae( dom , m1 , m2 , m3 , m4 , id );
