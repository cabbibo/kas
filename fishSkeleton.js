...
var shinyRed2 = new THREE.MeshPhongMaterial({
    ...
    for( var i = 0; i < 14; i++ ){
      ...
      m.scale.multiplyScalar( (1 - (i / 14) )* .2);
      m.updateMatrix();
    ...
    */
    ...
    var geo = new THREE.CylinderGeometry( .01, .01 , 1 );
    var mat = new THREE.MeshNormalMaterial();
    ...
    beak = new THREE.Mesh( 
      new THREE.CylinderGeometry( .1 , 0 , .3, 20 ),
      headMat 
    );

    beak.rotation.x = -Math.PI / 2;
    beak.position.z = 0.0001;
    ...
    */
    ...
    var geo = new THREE.CylinderGeometry( .1 , 0 , .2 , 10 );
    ...
    // child 1
    var geo = new THREE.BoxGeometry( .1 , .1 , .5 );
    var mesh = new THREE.Mesh(  geo , shinyYellow1 );

    fishSkeleton.flagella.child1 = mesh;

    // child 2
    var geo = new THREE.BoxGeometry( .1 , .1 , .5 );
    var mesh = new THREE.Mesh(  geo , shinyYellow2 );
